            ...
            <div class="flex flex-col overflow-y-auto md:flex-row h-screen">
                <div class="flex items-center justify-center md:w-1/3 md:p-6 w-full">
                    <div class="md:max-w-lg">
                        ...
                        <h1 class="mb-2 text-3xl text-gray-700">Masuk ke <span class="font-semibold">SIA</span></h1>
                        <p class="mb-4 text-cool-gray-400">Sistem Informasi Akademik <span class="font-semibold">Univeritas Mercubuana</span></p>
                        ...
                        <form>
                            ...
                            <a class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-lg active:bg-blue-500 hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue" href="../index.html">
                                Log in
                            </a>
                        </form>
                        <div class="block">

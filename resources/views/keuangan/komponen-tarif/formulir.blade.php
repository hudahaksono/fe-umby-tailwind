            ...
            <div class="flex">
                <div class="flex items-center"><span class="text-gray-600 font-medium">Filter&nbsp; :</span>
                    ...
                    <div class="mb-1 inline-flex items-center px-2 py-1">
                        <select id="kelas-mahasiswa" name="klsmhs" required
...
@section('scripts')
    <script>
        const dataSet = [{
                id: 1,
                kode: '13',
                nama_formulir: 'Kelas Reguler S1',
                periode: 'Gasal 2016',
                kelas_mhs: 'SPP Tetap',
                program:'S1',
                tarif:'250,000',
            },
            {
                id: 2,
                kode: '14',
                nama_formulir: 'Kelas Reguler D3',
                periode: 'Gasal 2016',
                kelas_mhs: 'SPP Tetap',
                program:'D3',
                tarif:'250,000',
            },
            {
                id: 3,
                kode: '15',
                nama_formulir: 'Kelas Reguler S2',
                periode: 'Gasal 2016',
                kelas_mhs: 'SPP Tetap',
                program:'S2',
                tarif:'250,000',
        ...
        new TomSelect('#kelas-mahasiswa', klsmhsSelect)

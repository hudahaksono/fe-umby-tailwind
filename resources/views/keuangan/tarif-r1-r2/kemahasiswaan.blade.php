...
@section('contents')
    ...
    <x-card title="Tarif Kemahasiswaan">
...
@section('scripts')
    <script>
        const dataSet = [{
                id: 1,
                angkatan:'2019',
                tarif_semester1:'300,000',
                tarif_selanjutnya:'300,000',
            },
            {
                id: 2,
                angkatan:'2015',
                tarif_semester1:'',
                tarif_selanjutnya:'100,000',
            },
            {
                id: 3,
                angkatan:'2015',
                tarif_semester1:'100,000',
                tarif_selanjutnya:'100,000',
            },
        ]
        ...
        $(document).ready(function() {
            $('#mahasiswa-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'tarif_semester1',
                        title: 'Tarif Semester 1'
                    },
                    {
                        data: 'tarif_selanjutnya',
                        title: 'Tarif Selanjutnya'
                    },
                    {
                        data: 'id',
                        title: 'Aksi',

...
@section('title', 'Portal Mahasiswa Lulus')

@section('contents')
    <!-- <x-card class="mb-6">
        FILTER
    </x-card> -->
    <x-card title="Mahasiswa Berstatus Lulus Gasal 2022">
...
@section('scripts')
    <script>
        const dataSet = [{
                id: 1,
                nim: '18081010',
                nama_mahasiswa: 'GABRIELLA YOLANDITA',
                jurusan: 'Psikologi',
                angkatan: 2018,
                status: 'Lulus',

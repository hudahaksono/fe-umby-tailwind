...
@section('title', 'Himbauan Pengawas Ujian')

@section('contents')
    <!-- <x-card class="mb-6">
        FILTER
    </x-card> -->
    <x-card title="HIMBAUAN PENGAWAS UJIAN">
			...
			<div class="basis-2/3 md:basis-1/2">
				<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
					...
					<tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
							<td class="px-6 py-4">Jenis Ujian</td>
							<td class="px-6 py-4" colspan="2">
								<select id="select-jenis-ujian" name="select-ujian" required
                                    class="block w-full mt-1 text-sm focus:border-blue-400 border-gray-200 focus:outline-none focus:shadow-outline-blue rounded ml-4">
                                </select>
                            </td>
						</tr>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
							<td class="px-6 py-4">Mata Kuliah</td>
							<td class="px-6 py-4" colspan="2">
								<select id="select-mata-kuliah" name="select-matkul" required
                                    class="block w-full mt-1 text-sm focus:border-blue-400 border-gray-200 focus:outline-none focus:shadow-outline-blue rounded ml-4">
                                </select>
                            </td>
						</tr>
...
var dosenSelect = {
    ...
    options: [
        ...
        {
            value: "112",
            text: "-- Nanda Yukina Wulandari S.Psi,"
        },
        {
            value: "112",
            text: "0001 - Diah Noviyana M.Pd"
        },
    ],
}
...
new TomSelect('#select-jenis-ujian', ujianSelect)
new TomSelect('#select-mata-kuliah', matkulSelect)

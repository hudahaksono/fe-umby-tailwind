...
@section('title', 'Presensi Ujian')

@section('contents')
    <!-- <x-card class="mb-6">
        FILTER
    </x-card> -->
    <x-card title="PRESENSI UJIAN">
				...
				<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
					...
					<tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
							...
							<td class="px-6 py-4" colspan="2">
								<select id="select-matkul" name="select-matkul" required
                                    class="block w-full mt-1 text-sm focus:border-blue-400 border-gray-200 focus:outline-none focus:shadow-outline-blue rounded ml-4">
                                </select>
                            </td>
						</tr>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
							<td class="px-6 py-4">Tipe Pertemuan</td>
							<td class="px-6 py-4" colspan="2">
								<select id="select-pertemuan" name="select-pertemuan" required
                                    class="block w-full mt-1 text-sm focus:border-blue-400 border-gray-200 focus:outline-none focus:shadow-outline-blue rounded ml-4">
                                </select>
                            </td>
						</tr>
...
new TomSelect('#select-matkul', matkulSelect)
new TomSelect('#select-pertemuan', pertemuanSelect)

...
@section('title', 'Lokasi Kampus Universitas')

{{-- YOUR CONTENT START HERE --}}
@section('contents')
    <x-title class="text-cool-gray-800 mb-5">Lokasi Kampus Universitas</x-title>
    <x-card>
...
@section('scripts')
    <script>
        const dataSet = [{
                id: 1,
                kodekampus: '00',
                kampus: 'Universitas Mercu Buana Yogyakarta',
                aksi: 'UMB Yogya',
            },
            {
                id: 2,
